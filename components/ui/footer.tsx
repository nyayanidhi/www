    ...
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-4">
            ...
            <ul className="text-sm">
              ...
              <li className="mb-2">
                <a href="/TnC.pdf" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Terms and Conditions</a>
              </li>
              <li className="mb-2">
                <a href="/Privacy.pdf" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Privacy Policy</a>
              </li>
              <li className="mb-2">
                <a href="/Refund.pdf" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Refund Policy</a>
              </li>
            </ul>
          </div>
              ...
              <div className="flex flex-wrap mb-4">
                <div className="w-full">
                  <div className="relative flex max-w-xs">
                    <button type="submit" className="absolute inset-0" aria-label="Get in touch">
                      <div className="flex flex-col sm:flex-row max-w-xs mx-auto sm:max-w-md lg:mx-0">
                        <a className="btn text-white bg-blue-600 hover:bg-blue-700 shadow" href="mailto:nyayanidhi18@gmail.com">Get in touch</a>
                      </div>
                    </button>
                  </div>
                  {/* Success message */}
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">&copy; Nyayanidhi.com. All rights reserved.</div>
